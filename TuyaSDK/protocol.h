...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "us5j3qwumhbgwotc"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//空气质量指数(只上报)
//备注:
#define DPID_AIR_QUALITY_INDEX 1
//温度(只上报)
//备注:
#define DPID_TEMP_CURRENT 2
//湿度(只上报)
//备注:
#define DPID_HUMIDITY_VALUE 3
//CO2(只上报)
//备注:
#define DPID_CO2_VALUE 4
//TVOC(只上报)
//备注:
#define DPID_TVOC 101
//亮度调节(可下发可上报)
//备注:led1
#define DPID_PM25_VALUE 7
//灯1(可下发可上报)
//备注:led1
#define DPID_LED_1 102
//灯2(可下发可上报)
//备注:
#define DPID_LED2 103
//灯3(可下发可上报)
//备注:
#define DPID_LED3 104
//开关1(可下发可上报)
//备注:
#define DPID_SWITCH1 105
//开关2(可下发可上报)
//备注:
#define DPID_SWITCH2 106
//开关3(可下发可上报)
//备注:
